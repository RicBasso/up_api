...
class UpApiSpacing {
  static const SizedBox spacingLabelField = SizedBox(height: 5);
  static const SizedBox spacingFormFields = SizedBox(height: 20);
  ...
  static const SizedBox mediumHorizontal = SizedBox(width: 10);
  static const SizedBox largeHorizontal = SizedBox(width: 20);
}
